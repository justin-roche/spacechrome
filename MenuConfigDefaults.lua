...
local chromeMenu = "chromeMenu"
-- local commandsMenu = "commandsMenu"

local chrome_elementsMenu = "chrome_elementsMenu"
local chrome_sourcesMenu = "chrome_sourcesMenu"
local chrome_consoleMenu = "chrome_consoleMenu"
local chrome_consoleNavMenu = "chrome_consoleNavMenu"
local chrome_networkMenu = "chrome_networkMenu"
...
menuHammerMenuList = {
    ...
    [mainMenu] = {
        parentMenu = nil,
        menuHotkey = {{'alt', 'command', 'control'}, 'm'},
        menuItems = {
          {cons.cat.submenu, '', 'C', 'Chrome', {
             {cons.act.menu, chromeMenu}
          }},
    ...
    chrome_commandsMenu = {
      ...
      menuHotkey = nil,
      menuItems = chrome_commandMenuItems
    },
    chrome_sourcesMenu = {
      parentMenu = chromeMenu,
      menuHotkey = nil,
    ...
    chrome_consoleMenu = {
      parentMenu = chromeMenu,
      menuHotkey = nil,
      menuItems = chrome_consoleMenuItems
    },
    chrome_consoleNavMenu = {
    ...
    chrome_elementsMenu = {
      parentMenu = chromeMenu,
      menuHotkey = nil,
      menuItems = chrome_elementsMenuItems
    },
    chrome_panelsMenu = {
      parentMenu = chromeMenu,
      menuHotkey = nil,
      menuItems = chrome_panelsMenuItems
    },
    chrome_networkMenu = {
      parentMenu = chromeMenu,
      menuHotkey = nil,
      menuItems = chrome_networkMenuItems
    },
    chrome_applicationMenu = {
      parentMenu = chromeMenu,
      menuHotkey = nil,
      menuItems = chrome_applicationMenuItems
    },
    chrome_windowsMenu = {
      parentMenu = chromeMenu,
      menuHotkey = nil,
      menuItems = chrome_windowsMenuItems
    },
    ------------------------------------------------------------------------------------------------
    -- Help Menu
    ------------------------------------------------------------------------------------------------
    ...
    hammerspoonMenu = {
        ...
        menuItems = {
            ...
            {cons.cat.action, '', '.', "Test", {
               {cons.act.func, function()
                  -- {cons.act.action, cons.HSearch.toggleShow()},
                  -- HSearch:toggleShow()
    ...
    systemMenu = {
        ...
        menuHotkey = nil,
        menuItems = {
          {cons.cat.action, '', 'a', "Close Alert", {
             {cons.act.func,
              function() 
                p =hs.screen.primaryScreen():frame()
                print("point",p.w)
                hs.eventtap.leftClick({x=p.w-35, y=35})
              end
             }
          }},
